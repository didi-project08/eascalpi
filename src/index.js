function callApi(method, url, opt) {
    let isValid = validation(method, url)
    if (isValid) {
...
function validation(method, url) {
    if (!method) {
        console.log('please provide your method!!')
        return false;
    } else if (!url) {
        console.log('please provide your api-URI!!')
        return false;
    } else if (!method && !url) {
        console.log('please provide your method and api-URI!!')
        return false;
    } else {
        console.info('passedd!!')
        return true;
    }
}
